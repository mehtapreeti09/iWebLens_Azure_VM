...
Create a VM on your Azure portal. Make sure you open the SSH port on your VM while creation or update after creating the VM.

You can use the provided VM_ARM template in this repo to create a VM using below steps-
1. Search for 'Deploy a custom template' in Azure 
2. Click on 'Build your own template in the editor'
3. Upload the template and the parameter files
4. Check parameters
5. Create password 
6. Deploy

Once VM is up and running with SSH port open for accessing the VM, SSH into the VM using Azure.

Make sure you install Python 3, docker and Kubernetes on your VM before performing steps below to run the application.
